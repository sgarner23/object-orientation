...
let cat1 = new Cat("Mr. Snuggles", 4, "black");
...
let theGreatestWizard = new Wizard("Gandolf", 323, "Boombora");

theGreatestWizard.castSpell();
...
//Code Here
let phone1 = new Phone("Apple", "iPhone12", 258, "black", 1000);
let phone2 = new Phone("Samsung", "Galaxy", 500, "white", 700);
let phone3 = new Phone("Samsung", "Note", 258, "red", 1200);
...
//Code Here
let myFirstVehicle = new Vehicle(4, "red", 50000);
...
let myFirstMotorcycle = new Motorcycle("Harley", true, 1, "black", 156);
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorcycle.move(44);
